...
describe('ModalForm', ()=> {
  ...
  it.skip('Sets the default input values to the cards current text and priority', () => {
  render(<App/>)
  Modal.setAppElement(document.querySelector('div') as HTMLDivElement)
  const textInput = screen.getByRole('textbox')
  const addBtn = screen.getByRole('button')
  ...
  const edtBtn = screen.getByText('Edit')
  userEvent.click(edtBtn)
  const modalTextInput = screen.getByText('Edit Todo Description')
  const modalPriorityInput = screen.getByText('Edit Priority Level')
  ...
  const modalPriorityInput = screen.getByText('Edit Priority Level')
  const closeBtn = screen.getByText('Close')
  userEvent.type(modalTextInput, '{backspace}') 
  userEvent.type(modalPriorityInput, '{backspace}4') 
  userEvent.click(closeBtn)
